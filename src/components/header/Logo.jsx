export default () => {
    return (
        <h1>
            <a href="https://shoteasy.lingxiangtools.top" target="_blank" aria-label="灵象" className="flex gap-1 text-gray-700 dark:text-gray-300 items-center text-xs font-semibold">
